    ...
    <main id="main" class="row" >
        <section id="menuBuscar"  class="col-2">
            <section id="param" class="row">
                ...
                <h5 class="col-12">Ordenadores(com)</h5>
                <input class="col-1" type="checkbox" name="componentes" value="componentes">
                <label class="col-11" name="componentes" value="componentes" >Torres</label>
                 <input class="col-1" type="checkbox" name="componentes" value="componentes">
                <label class="col-11" name="componentes" value="componentes" >Portatiles</label>
                 <input class="col-1" type="checkbox" name="componentes" value="componentes">
                <label class="col-11" name="componentes" value="componentes" >Pantallas</label>
