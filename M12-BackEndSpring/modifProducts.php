        ...
        <section class="col-9" >
            ...
            <section id="informacion" class="col-12"  >
                <h3>Modificar Productos</h3>
                    <?php 
                        include("productosModificar.php");
                    ?>
                    <button id="get" type="submit"  onclick="mostrarProducts()" >Mostrar producto</button>
                    <button id="update" type="submit"  onclick="updateProduct()" >Modificar producto</button>
                    <button id="delete" type="submit"  onclick="deleteProduct()" >Borrar producto</button>
